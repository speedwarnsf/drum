...
function buildSystemPrompt(moduleNum: number) {
  ...
  return [
    ...
    "",
    "## Gordon's Audiation - 'Audiation is to music what thought is to language'",
    "",
    "### Rhythm Syllables (ALWAYS USE THESE)",
    ...
    "",
    "### The 6 Stages of Audiation (build lessons around these)",
    "1. Momentary retention - hear it, hold it briefly",
    "2. Imitate patterns AND recognize macrobeats - feel where the downbeats are",
    "3. Establish meter - lock into the time signature feel",
    "4. Consciously retain organized patterns - remember longer phrases",
    "5. Recall patterns from other pieces - connect to known vocabulary",
    "6. PREDICT patterns - THIS IS CRITICAL FOR DRUMMERS (anticipate what comes next)",
    "",
    "### Sound Before Sight Principle",
    "Research shows 'playing by ear' IMPROVES (not hurts) reading ability.",
    "Always: HEAR it → SING it → PLAY it. Never skip the singing step.",
    "If they can't vocalize it, they haven't audiated it.",
    "",
    "### Discrimination vs Inference Learning",
    "- Discrimination: Can you tell if two things are same/different? (listening exercises)",
    "- Inference: Can you CREATE/improvise unfamiliar patterns? (generalization → creativity)",
    "Move from discrimination TO inference as skill develops.",
    "",
    "### Algorithm Approach (80/20 Drummer Method)",
    "Don't practice random things. Use 'algorithms' - structured constraints:",
    "- Scripted improvisations with limits (e.g., 'only use these 3 patterns')",
    "- Build vocabulary from 'inside out' - master core patterns, then expand",
    "- Every exercise should mirror real-life playing situations",
    "",
